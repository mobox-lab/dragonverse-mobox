export const DawnBringerABI = [
  ...
  { inputs: [], name: 'MintExpired', type: 'error' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'newSigners', type: 'address' }],
    name: 'SetSigners',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'string', name: 'newTokenURI', type: 'string' }],
    name: 'SetTokenUri',
    type: 'event',
  },
  {
