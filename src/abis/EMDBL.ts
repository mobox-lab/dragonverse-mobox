export const EMDBLABI = [
  ...
  {
    inputs: [],
    name: 'NoMintLimitAvailable',
    type: 'error',
  },
  {
    inputs: [],
    name: 'NotEnoughAvailableAmount',
    type: 'error',
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: 'RedemptionFinish',
    type: 'error',
  },
  {
    inputs: [],
    name: 'RedemptionNotEnded',
    type: 'error',
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: 'batchAddTransferWhitelist',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'getRedemptionRequestArray',
    outputs: [
      {
        components: [
          {
        ...
        internalType: 'struct eMDBL.RedemptionRequestExt[]',
        name: '',
        type: 'tuple[]',
      },
    ],
  ...
  },
  {
    ...
    name: 'getUserCanRedemptionBalance',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  },
  {
    ...
    name: 'getUserHasUsedPermitQuota',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
...
// TypeScript utility function: style: 💄 improve mobile responsiveness
interface DataItem {
  id: string;
  value: any;
  processed?: boolean;
...
export const refactor____optimize_component_structure: UtilityFunctions = {
  format: (value: number | string): string => {
    return value.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
  },
  validate: (input: string): boolean => {
