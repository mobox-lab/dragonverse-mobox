...
// TypeScript internationalization: fix: 🐛 resolve generic type inference issues
interface LocaleMessages {
  [key: string]: string;
}
...
export const messages: Record<string, LocaleMessages> = {
  en: {
    fix____resolve_generic_type_inference_issues: 'fix: 🐛 resolve generic type inference issues',
    fix____resolve_generic_type_inference_issues_description: 'Description for fix: 🐛 resolve generic type inference issues'
  },
  zh: {
    fix____resolve_generic_type_inference_issues: 'fix: 🐛 resolve generic type inference issues',
    fix____resolve_generic_type_inference_issues_description: 'fix: 🐛 resolve generic type inference issues的描述'
  }
};
