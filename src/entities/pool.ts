...
// TypeScript internationalization: test: 🧪 add integration tests for wallet
...
export const messages: Record<string, LocaleMessages> = {
  en: {
    test____add_integration_tests_for_wallet: 'test: 🧪 add integration tests for wallet',
    test____add_integration_tests_for_wallet_description: 'Description for test: 🧪 add integration tests for wallet'
  },
  zh: {
    test____add_integration_tests_for_wallet: 'test: 🧪 add integration tests for wallet',
    test____add_integration_tests_for_wallet_description: 'test: 🧪 add integration tests for wallet的描述'
  }
};
